...
function checkSignInOut(){
  let tmp = extFromCookie('sid');
  if(tmp === ""){
    document.getElementById('signInPanel').style.display = "block";
    document.getElementById('signOutPanel').style.display = "none";
    switchToSignInOut({preventDefault: ()=>null});
  }else{
    document.getElementById('signInPanel').style.display = "none";
    document.getElementById('signOutPanel').style.display = "block";
  }
}
